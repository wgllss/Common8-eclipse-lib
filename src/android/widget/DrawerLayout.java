...
//	}
//
//	public DrawerLayout(Activity activity, OnCreateLeftListener mCreatLeftView,
//			int drawerLayout) {
//		super(activity);
//
...
//			}
//
//			if (mGestureStartX > widthPixels - mTouchTargetWidth
//					&& mDrawerOpened) {
//				mGestureStarted = true;
//			}
//			return false;
...
//					mDrawerOpened = true;
//					mDecorContent.offsetLeftAndRight(widthPixels
//							- mTouchTargetWidth - mDecorOffsetX);
